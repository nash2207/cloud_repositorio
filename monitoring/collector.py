...
class MetricsCollector:
    ...
    def get_worker_capacity(self, worker_ip):
        ...
        try:
            ...
            # RAM (KB) - Fixed awk command
            ram_cmd = r"grep MemTotal /proc/meminfo | awk '{print \$2}'"
            ...
            # Disk space on / (parse "df -h /" output) - Fixed awk command
            disk_cmd = r"df / | tail -1 | awk '{print \$2}'"
